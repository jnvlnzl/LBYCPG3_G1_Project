        ...
        <section id="about">
          <div class="container">
            <div class="row">
              <div class="col-md-6">
                <h1>M402A</h1>
                <h3>Electrical Machine Laboratory</h3>
                <p>The laboratory is equipped with equipment and trainers needed to conduct all tests and measurements to learn more about the 
                    major types of DC/AC motors and generators and single- and three-phase transformers. The training modules combine theory and 
                    application with practical skill-training techniques.
                </p>
                <h4>Equipment</h4>
                <p>Electromechanical training systems, Motors, Generators, Transformers, Wattmers, Tachometers</p>
              </div>
              <div class="col-md-6">
                <img src="../assets/laboratories/M402A.jpg" alt="Electrical Machine Laboratory" class="img-fluid">
              </div>
            </div>
          </div>
        </section>
